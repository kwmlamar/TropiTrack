-- Revert payroll notification fix

-- Drop the fixed payroll notification trigger
DROP TRIGGER IF EXISTS payroll_notification_trigger ON payroll;

-- Recreate the original payroll notification function
...
-- Recreate the original payroll notification trigger
