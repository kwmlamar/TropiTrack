-- Fix payroll notifications to properly exclude the user who performed the action

-- Drop the existing payroll notification trigger
DROP TRIGGER IF EXISTS payroll_notification_trigger ON payroll;

-- Recreate the payroll notification function with better user exclusion logic
