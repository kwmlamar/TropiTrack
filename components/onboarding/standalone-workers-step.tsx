...
import { saveOnboardingData, completeOnboardingStep } from '@/lib/actions/onboarding-actions';
...
export function StandaloneWorkersStep() {
  ...
  const saveWorkers = async () => {
    ...
    try {
      ...
      // Complete the workers step in onboarding
      await completeOnboardingStep(userId, 'workers', {
        workers: workers,
