...
import { generateWorker, fetchWorkersForCompany, deleteEmployee, updateEmployee } from "@/lib/data/data"
...
export default function WorkersTable({ user }: { user: User }) {
  ...
  const handleUpdateWorker = async (employee: Worker) => {
    try {
      ...
      setWorkers(workers.map((e) => (e.id === employee.id ? updatedEmployee : e)))
    } catch (error) {
              ...
              <DialogHeader>
                ...
                <DialogDescription>
                  {selectedWorker
                    ...
                    : "Fill in the details to add a new worker to your team."}
                </DialogDescription>
              </DialogHeader>
              <WorkerForm
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete <strong>{selectedWorker?.name}</strong> from your team. This action cannot
                be undone and will remove all associated timesheet data.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
