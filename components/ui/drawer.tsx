    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          // Light mode - explicit colors (matching DialogContent)
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1.5 w-[60px] shrink-0 rounded-full bg-[#d1d5db] dark:bg-[#52525b] group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
